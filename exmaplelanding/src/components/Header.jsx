    ...
    <div className=' pt-[100px] relative '>
        <div className="grid lg:grid-cols-[3fr_2fr] mb-5 gap-4">
                ...
                <div className=' space-y-4 relative'>
                    <h1 className=' text-5xl md:text-8xl font-mont font-[700] text-center lg:text-start lg:ml-10 z-[98]'>PEAK OF <span className='text-[rgb(232,208,205)]'>LUXURY</span></h1>
                        ...
                        <div>
                            <div className=' px-6 sm:w-3/4 mx-auto lg:mx-0'>
                                <p className='text-start text-md ml-6 font-fig font-[800]'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolorum ipsa porro iure nihil rem tenetur vitae deserunt placeat! Quos, sequi.</p>
                                {/* text-[rgb(255,110,58)] */}
                            </div>
                        </div>
                </div>

            <div className=' bg-white rounded-[40px] p-6 shadow-[0px_0px_10px_0px] shadow-black/20'>
                    <div className="relative top-[50%] translate-y-[-50%]">
                        <div className=' grid sm:grid-cols-2 gap-4'>
                            <div>
                                <div className=' relative top-[50%] translate-y-[-50%]'>
                                    <PiApproximateEqualsBold className=' text-4xl'/>
                                    <h1 className=' font-fig font-[600] text-3xl'>LUXURY INTERIOR</h1>
                                    <div className=' bg-[rgb(238,238,238)] shadow-[0px_0px_10px_0px] shadow-black/20 p-3 rounded-3xl mt-4'>
                                        {pros.map((element, i)=>(
                                            <div className=' flex justify-between'>
                                                <p className=' font-fig font-[300]'>{element.prosElement}</p>
                                                <p className=' font-fig font-[600]'>{element.prosNumber}</p>
                                            </div>
                                        ))}
                                    </div>
                                </div>
        ...
        <div className="grid lg:grid-cols-[5fr_2fr] gap-2 md:gap-5">
            <div className=' overflow-y-hidden rounded-[40px] md:rounded-[60px] max-h-[630px] shadow-[0px_0px_10px_0px] shadow-black/20'>
            ...
            <div className='sm:grid-cols-2 lg:grid-cols-1 grid gap-2 md:gap-5 h-full '>
                    <div className=' bg-[rgb(126,206,255)] rounded-[40px] p-6 min-h-[300px]'>
                    ...
                    <div className=' bg-[#0a0a0a] text-white rounded-[40px] p-6 min-h-[300px]'>
                        <FaStarOfLife className='my-2 text-xl'/>
