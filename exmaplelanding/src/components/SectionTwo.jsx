    ...
    <div className=' w-full bg-[#f3f3f3]'>
        <div className=' relative p-6 max-w-[1500px] mx-auto'>
                ...
                <div className=' md:w-2/3 mx-auto my-10 grid'>
                    ...
                    <div className=' md:w-1/2 w-3/4 relative text-center'>
                        <FaStarOfLife className=' text-4xl text-[rgba(160,86,42)] absolute right-5'/>
                        <h1 className=' font-mont font-[700] text-5xl mt-10'>Lorem ipsum dolor sit amet.</h1>
                    </div>

                    <div className=' md:w-1/2 w-3/4 relative left-1/4 md:left-1/2 md:ml-5 text-center'>
                ...
                <div className=' w-3/4 mx-auto text-center mb-10 pt-10'>
                        <p className=' font-fig font-[600] text-xl'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illum, mollitia deserunt? Voluptatibus ullam dolores nobis doloribus nostrum, distinctio consectetur minima.</p>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="w-full h-full bg-black rounded-2xl md:rounded-[40px] overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1505873242700-f289a29e1e0f?q=80&w=2076&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="image"  className=' h-full object-cover opacity-50'/>
                    </div>
